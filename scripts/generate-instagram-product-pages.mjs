...
const generatedDate = '2026-08-19';
...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;background:linear-gradient(145deg,#fffaf7,#f8dfdd);color:var(--ink);font-family:system-ui,-apple-system,"Segoe UI","Noto Sans Thai",sans-serif;line-height:1.55}
    ...
    .price{font:700 38px/1 Georgia,"Times New Roman",serif}.price small{font:600 16px system-ui,-apple-system,"Segoe UI",sans-serif}.facts{display:flex;flex-wrap:wrap;gap:8px;padding:0;margin:20px 0;list-style:none}.facts li{padding:7px 11px;border-radius:999px;background:#f6ece7;font-size:12px}
  ...
  <main class="shell">
    ...
    <article class="product">
      ...
      <div class="copy">
        ...
        <div class="price">${product.price} <small>บาท / ชิ้น</small></div>
